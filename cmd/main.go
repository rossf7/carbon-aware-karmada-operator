...
import (
	...
	"github.com/rossf7/carbon-aware-karmada-operator/internal/controller"
...
func main() {
	...
	flag.StringVar(&providerName, "provider-name", "ElectricityMap", "The grid-intensity-go provider to use.")
	opts := zap.Options{
		Development: true,
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7e1e6420.rossf7.github.io",
